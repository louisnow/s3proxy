...
* gcs-sdk (recommended for Google Cloud Storage)
...
* conditional PUT object when using If-Match or If-None-Match (native support for `azureblob-sdk` and `gcs-sdk` providers; emulated for others)
